...
#if 0
static char gamma0[10] = {0xc0, 0x01, 0x44, 0x76, 0x01, 0x00, 0x00, 0x30, 0x20, 0x01};
static char gamma1[10] = {0xc1, 0x01, 0x44, 0x76, 0x01, 0x00, 0x00, 0x30, 0x20, 0x01};
static char gamma2[10] = {0xc2, 0x01, 0x44, 0x76, 0x01, 0x00, 0x00, 0x30, 0x20, 0x01};
static char gamma3[10] = {0xc3, 0x01, 0x44, 0x76, 0x01, 0x00, 0x00, 0x30, 0x20, 0x01};
static char gamma4[10] = {0xc4, 0x01, 0x23, 0x74, 0x00, 0x1F, 0x10, 0x50, 0x33, 0x03};
static char gamma5[10] = {0xc5, 0x01, 0x23, 0x74, 0x00, 0x1F, 0x10, 0x50, 0x33, 0x03};
static char gamma6[10] = {0xc6, 0x01, 0x44, 0x76, 0x01, 0x00, 0x00, 0x30, 0x20, 0x01};
static char gamma7[10] = {0xc7, 0x01, 0x44, 0x76, 0x01, 0x00, 0x00, 0x30, 0x20, 0x01};
static char gamma8[10] = {0xc8, 0x01, 0x44, 0x76, 0x01, 0x00, 0x00, 0x30, 0x20, 0x01};
static char gamma9[10] = {0xc9, 0x01, 0x44, 0x76, 0x01, 0x00, 0x00, 0x30, 0x20, 0x01};
static char gammaa[10] = {0xca, 0x01, 0x23, 0x74, 0x00, 0x1F, 0x10, 0x50, 0x33, 0x03};
static char gammab[10] = {0xcb, 0x01, 0x23, 0x74, 0x00, 0x1F, 0x10, 0x50, 0x33, 0x03};
static char gammac[10] = {0xcc, 0x01, 0x23, 0x74, 0x00, 0x1F, 0x10, 0x50, 0x33, 0x03};
static char gammad[10] = {0xcd, 0x01, 0x23, 0x74, 0x00, 0x1F, 0x10, 0x50, 0x33, 0x03};
static char gammae[10] = {0xce, 0x01, 0x23, 0x74, 0x00, 0x1F, 0x10, 0x50, 0x33, 0x03};
static char gammaf[10] = {0xcf, 0x01, 0x23, 0x74, 0x00, 0x1F, 0x10, 0x50, 0x33, 0x03};
#endif
...
static struct dsi_cmd_desc lgit_power_on_set_1_LD083WU1[] = {
	...
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(gamma2), gamma2},
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(gamma3), gamma3},
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(gamma4), gamma4},
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(gamma5), gamma5},
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(gamma6), gamma6},
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(gamma7), gamma7},
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(gamma8), gamma8},
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(gamma9), gamma9},
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(gammaa), gammaa},
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(gammab), gammab},
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(gammac), gammac},
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(gammad), gammad},
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(gammae), gammae},
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(gammaf), gammaf},
#endif
};
