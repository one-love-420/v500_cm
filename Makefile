...
KERNELFLAGS	= -fno-var-tracking-assignments -ffast-math -fforce-addr -fgcse-las -fgcse-sm -fsched-spec-load -fsingle-precision-constant -munaligned-access -mcpu=cortex-a15 -mfpu=neon-vfpv4 -mtune=cortex-a15 -mvectorize-with-neon-quad -pipe
